package com.gm.client.authorization.code.domain;

public class GlobalConstant {
	public final static String VERIFICATION_CODE = "verificationCode";// 验证码key
	public final static String LOGIN_FAILURE_URL = "/login";// 登录失败返回页面
	public final static String LOGIN_PAGE = "/login";// 登录页面
	public final static String LOGIN_PROCESSING_URL = "/login.do";// 登录处理URL
	public final static String CAPTCHA_URL = "/captcha";// 图片验证码URL
	public final static String LOGOUT_URL = "/logout.do";// 登出处理URL
	public final static String SYSTEM_USER = "system";// 系统用户
	...
	public final static int DELETE_SIGN = 1;// 删除标记
	public final static int DISABLES_SIGN = 1;// 禁用标记
	public final static int RECOVERY_SIGN = 1;// 恢复标记
}
